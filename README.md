...
**[Todo App]** is an app that allows users to add todo items and also delete them.
...
- **[Delete multiple items at once on list]**
...
```sh
  cd my-folder
  git clone https://github.com/Jaymelfah/todo-app.git
```
